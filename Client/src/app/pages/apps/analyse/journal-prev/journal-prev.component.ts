...
import { formDeleteTxt, tableSource } from './journal-prev.data';
...
@Component({
  selector: 'app-journal-prev',
  templateUrl: './journal-prev.component.html',
  styleUrls: ['./journal-prev.component.scss']
})
export class JournalPrevComponent implements OnInit {
  ...
  constructor(private router: Router, 
    ...
    private fyService: FyService, private jrService: JournalPrevRowService) { }
